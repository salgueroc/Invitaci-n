    ...
    <section id="recepcion" class="panel">
        ...
        <div class="wrapper">
            ...
            <article class="card">
                ...
                <img
                    src="assets/icons/recepcion.svg"
                    alt="Recepción"
                    class="icon">
        ...
        <div class="wrapper">
            ...
            <article class="dress-card">
                ...
                <div class="dress-colors">
                    ...
                    <div class="dress-color white"></div>

                    <div class="dress-color blue"></div>

                    <div class="dress-color mint"></div>
...
<path d="M32 6L12 22V58H52V22L32 6Z"
fill="#14375A"/>
...
<path
fill="#14375A"
d="M32 6C21 6 12 15 12 26c0 16 20 32 20 32s20-16 20-32C52 15 43 6 32 6z"/>
...
<path
fill="#FFFFFF"
d="M16 4C9.4 4 4 9.2 4 15.7c0 2.5.8 4.8 2.1 6.7L4 28l5.8-1.9c1.8 1 3.9 1.6 6.2 1.6 6.6 0 12-5.2 12-11.7S22.6 4 16 4zm6.6 16.4c-.3.8-1.7 1.5-2.3 1.6-.6.1-1.3.2-4.2-1-.9-.4-1.9-1.1-3.2-2.4-1.2-1.2-2-2.6-2.3-3.1-.2-.5-1-1.4-1-2.7s.7-2 1-2.3c.3-.3.7-.4 1-.4h.7c.2 0 .5 0 .8.7.3.7 1 2.4 1.1 2.5.1.2.1.4 0 .6-.1.2-.2.4-.4.6l-.6.7c-.2.2-.4.4-.2.8.2.4.8 1.3 1.8 2.1 1.2 1 2.2 1.3 2.6 1.5.4.2.6.2.8-.1l1-1.2c.2-.3.5-.3.8-.2.3.1 2 .9 2.3 1.1.3.2.5.2.6.4.1.2.1 1-.2 1.8z"/>
